...
IceUtil::ThreadSyscallException::ThreadSyscallException(const char* file, int line, int err) :
  Exception(file, line), _error(err)
{
}

const char* IceUtil::ThreadSyscallException::_name = "IceUtil::ThreadSyscallException";

const string IceUtil::ThreadSyscallException::ice_name() const
{
  return _name;
}

void IceUtil::ThreadSyscallException::ice_print(ostream& os) const
{
...
void IceUtil::ThreadSyscallException::ice_throw() const
{
  throw *this;
}

int IceUtil::ThreadSyscallException::error() const
{
  return _error;
}
...
const string IceUtil::ThreadLockedException::ice_name() const
{
  return _name;
}
...
void IceUtil::ThreadLockedException::ice_throw() const
{
  throw *this;
}
...
const string IceUtil::ThreadStartedException::ice_name() const
{
  return _name;
}
...
void IceUtil::ThreadStartedException::ice_throw() const
{
  throw *this;
}
...
const string IceUtil::ThreadNotStartedException::ice_name() const
{
  return _name;
}
...
void IceUtil::ThreadNotStartedException::ice_throw() const
{
  throw *this;
}
...
const string IceUtil::BadThreadControlException::ice_name() const
{
  return _name;
}
...
void IceUtil::BadThreadControlException::ice_throw() const
{
  throw *this;
}
