...
const ::std::string IceUtil::DeadlockException::ice_name() const
{
  return _name;
}
...
void IceUtil::DeadlockException::ice_throw() const
{
  throw *this;
}

IceUtil::RWRecMutex::RWRecMutex() :
  _count(0), _waitingWriters(0), _upgrading(false)
{
}
...
void IceUtil::RWRecMutex::readLock() const
{
...
bool IceUtil::RWRecMutex::tryReadLock() const
{
  Mutex::Lock lock(_mutex);
...
bool IceUtil::RWRecMutex::timedReadLock(const Time& timeout) const
{
  Mutex::Lock lock(_mutex);
...
void IceUtil::RWRecMutex::writeLock() const
{
  Mutex::Lock lock(_mutex);
...
bool IceUtil::RWRecMutex::tryWriteLock() const
{
  Mutex::Lock lock(_mutex);
...
bool IceUtil::RWRecMutex::timedWriteLock(const Time& timeout) const
{
  Mutex::Lock lock(_mutex);
...
void IceUtil::RWRecMutex::unlock() const
{
  bool ww = false;
  bool wr = false;
  {
...
void IceUtil::RWRecMutex::upgrade() const
{
  Mutex::Lock lock(_mutex);
...
bool IceUtil::RWRecMutex::timedUpgrade(const Time& timeout) const
{
  Mutex::Lock lock(_mutex);
...
void IceUtil::RWRecMutex::downgrade() const
{
  Mutex::Lock lock(_mutex);
