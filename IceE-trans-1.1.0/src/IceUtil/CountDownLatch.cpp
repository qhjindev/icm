...
void IceUtil::CountDownLatch::await() const
{
#ifdef _WIN32
...
void IceUtil::CountDownLatch::countDown()
{
#ifdef _WIN32
...
int IceUtil::CountDownLatch::getCount() const
{
#ifdef _WIN32
...
#ifndef _WIN32
void IceUtil::CountDownLatch::lock() const
{
...
void IceUtil::CountDownLatch::unlock() const
{
