...
const string IceUtil::Exception::ice_name() const
{
  return _name;
}
...
void IceUtil::Exception::ice_throw() const
{
  throw *this;
}
...
const string IceUtil::NullHandleException::ice_name() const
{
  return _name;
}
...
void IceUtil::NullHandleException::ice_throw() const
{
  throw *this;
}
...
IceUtil::IllegalArgumentException::IllegalArgumentException(const char* file,
                                                            int line,
                                                            const string& r) :
  Exception(file, line), reason(r)
{
}

const char* IceUtil::IllegalArgumentException::_name = "IceUtil::IllegalArgumentException";

const string IceUtil::IllegalArgumentException::ice_name() const
{
  return _name;
}
...
void IceUtil::IllegalArgumentException::ice_throw() const
{
  throw *this;
}
