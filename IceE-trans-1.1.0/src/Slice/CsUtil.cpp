...
static string lookupKwd(const string& name, int baseTypes, bool mangleCasts = false)
{
  ...
  //
  static const string keywordList[] = { "abstract", "as", "base", "bool", "break", "byte", "case",
...
string Slice::CsGenerator::typeToString(const TypePtr& type)
{
  if (!type) {
    return "void";
  }

  static const char* builtinTable[] = { "byte", "bool", "short", "int", "long", "float", "double",
      "string", "Ice.Object", "Ice.ObjectPrx", "Ice.LocalObject" };
...
void Slice::CsGenerator::writeMarshalUnmarshalCode(Output &out,
                                                   const TypePtr& type,
                                                   const string& param,
                                                   bool marshal,
                                                   bool streamingAPI,
...
void Slice::CsGenerator::writeSequenceMarshalUnmarshalCode(Output& out,
                                                           ...
                                                           bool streamingAPI)
{
  ...
  if (cl) {
    if (marshal) {
      ...
      out << sb;
      out << nl << "IceInternal.SequencePatcher spx = new IceInternal.SequencePatcher(" << param
          << ", " << "typeof(" << typeS << "), ix__);";
      out << nl << stream << ".readObject(";
      if (streamingAPI) {
        out << "(Ice.ReadObjectCallback)";
...
void Slice::CsGenerator::MetaDataVisitor::visitList(const ListPtr& p)
{
  validate(p);
}
