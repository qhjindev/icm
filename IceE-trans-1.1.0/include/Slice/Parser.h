...
typedef ::IceUtil::Handle<List> ListPtr;
...
public:
    ...
    virtual void visitList(const ListPtr&) { }
...
public:
    ...
    ListPtr createList(const std::string&, const TypePtr&, bool);
...
class SLICE_API List : virtual public Constructed
{
public:
...
protected:
    ...
    List(const ContainerPtr&, const std::string&, const TypePtr&, bool);
    friend class Container;
