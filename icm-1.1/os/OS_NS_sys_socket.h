 ...
 *
 *  $Id: OS_NS_sys_socket.h,v 1.2 2009/03/19 05:29:23 qinghua Exp $
 *
...
#ifndef OS_NS_SYS_SOCKET_H
# define OS_NS_SYS_SOCKET_H
...
/// These are available values for the @a how argument to OS::shutdown().
