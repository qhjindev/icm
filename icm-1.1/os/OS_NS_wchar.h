 ...
 *  @file   OS_NS_wchar.h
 *
 *  $Id: OS_NS_wchar.h,v 1.2 2009/03/19 05:29:23 qinghua Exp $
 *
...
#ifndef OS_NS_WCHAR_H
# define OS_NS_WCHAR_H
...
#include "os/os_include/os_wchar.h"
#include "os/Basic_Types.h"
#include /**/ "os/ACE_export.h"
#include "os/ace_wchar.h" // include for the time being, but this code needs to be moved.  dhinton
