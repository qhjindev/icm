 ...
 *
 *  $Id: config-macros.h,v 1.2 2009/03/19 05:29:23 qinghua Exp $
 *
...
#if !defined (OSTREAM_TYPE)
# if defined (ACE_LACKS_IOSTREAM_TOTALLY)
#   define OSTREAM_TYPE FILE
 ...
 * OSCALL* macros
 *
 * @deprecated OSCALL_RETURN and OSCALL should not be used.
...
#  define OS_String OS
#endif /* OS_String */
#if !defined (OS_Memory)
#  define OS_Memory OS
#endif /* OS_Memory */
#if !defined (OS_Dirent)
#  define OS_Dirent OS
#endif /* OS_Dirent */
#if !defined (OS_TLI)
#  define OS_TLI OS
