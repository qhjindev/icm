 ...
 *  threads
 *
 *  $Id: os_pthread.h,v 1.2 2009/03/19 05:29:23 qinghua Exp $
 *
...
#ifndef OS_INCLUDE_OS_PTHREAD_H
#define OS_INCLUDE_OS_PTHREAD_H
...
public:
  ...
  /// Number of threads that have called <OS::sema_wait>.
  u_long waiters_;
};
