 ...
 *  @file   OS_NS_dirent.h
 *
 *  $Id: OS_NS_dirent.h,v 1.2 2009/03/19 05:29:23 qinghua Exp $
 *
...
#ifndef OS_NS_DIRENT_H
# define OS_NS_DIRENT_H
...
#include "os/os_include/os_dirent.h"
...
// uses void*, that's handled internal to the OS::scandir() wrapper using
