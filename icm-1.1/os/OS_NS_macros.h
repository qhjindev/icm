 ...
 *  @file   OS_NS_macros.h
 *
 *  $Id: OS_NS_macros.h,v 1.2 2009/03/19 05:29:23 qinghua Exp $
 *
...
#ifndef OS_NS_MACROS_H
# define OS_NS_MACROS_H
...
#else
# define ACE_SOCKCALL_RETURN(OP,TYPE,FAILVALUE) OSCALL_RETURN(OP,TYPE,FAILVALUE)
# define ACE_SOCKCALL(OP,TYPE,FAILVALUE,RESULT) OSCALL(OP,TYPE,FAILVALUE,RESULT)
#endif /* ACE_WIN32 */
...
// This is more consistent with the rest of OS and enables us to
// use the OSCALL* macros.
...
// and FALSE) into int values expected by the OSCALL macros.
...
# define ACE_FAIL_RETURN(RESULT) do { \
  switch (OS::set_errno_to_last_error ()) { \
