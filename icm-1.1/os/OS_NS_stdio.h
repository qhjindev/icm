 ...
 *  @file   OS_NS_stdio.h
 *
 *  $Id: OS_NS_stdio.h,v 1.2 2009/03/19 05:29:23 qinghua Exp $
 *
...
#ifndef OS_NS_STDIO_H
# define OS_NS_STDIO_H
...
/// Helper for the OS::cuserid() function
/**
 * On some platforms cuserid is a macro.  Defining OS::cuserid()
 ...
 *
 * @todo We maybe should move a lot of the code in OS::cuserid here so
 *       it is treated the same as the above ace_difftime and ace_timezone.
 *       But since there is a good deal more code in OS::cuserid, we
