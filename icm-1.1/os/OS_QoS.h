 ...
 *  @file   OS_QoS.h
 *
 *  $Id: OS_QoS.h,v 1.2 2009/03/19 05:29:23 qinghua Exp $
 *
...
#include "os/os_include/sys/os_uio.h"
 ...
 * enabled <OS::connect> and <OS::join_leaf> methods.
 */
...
// Callback function that's used by the QoS-enabled <OS::accept>
// method.
