...
int main(int argc, char* argv[]) {
  ...
  Reference ref(comm, Identity("MyHello"), Endpoint("TCP", "172.30.2.70", 3000), new TimeValue(2));
  //Reference ref(comm, Identity("MyHello"), Endpoint("TCP", "172.16.10.23", 3000), new TimeValue(2));
  IcmProxy::demo::MyHello myHello;
